...
cfg["submit_version"] = "DY_2017_20_9_2019"
...
cfg["train_sample"] = '/DYJetsToLL_M-50_TuneCP5_13TeV-amcatnloFXFX-pythia8/RunIIFall17MiniAODv2-PU2017_12Apr2018_94X_mc2017_realistic_v14_ext1-v1/MINIAODSIM'
...
cfg["test_sample"] = '/DYJetsToLL_M-50_TuneCP5_13TeV-amcatnloFXFX-pythia8/RunIIFall17MiniAODv2-PU2017_12Apr2018_94X_mc2017_realistic_v14_ext1-v1/MINIAODSIM'
...
# ID + ISO
cfg["trainings"] = {}
cfg["trainings"]["Fall_17_ID_ISO"] = {}

cfg["trainings"]["Fall_17_ID_ISO"]["pT_5"] = {
        "cut": "mu_pT < 10. & abs(mu_eta) <= 2.4",
        "variables": variables_base_iso,
        "label": r'5 < $p_T$ < 10 GeV, ($|\eta| < 2.4$)',
        }
        
cfg["trainings"]["Fall_17_ID_ISO"]["pT_10"] = {
        "cut": "mu_pT >= 10. & abs(mu_eta) <= 2.4",
        "variables": variables_base_iso,
        "label": r'5 < $p_T$ > 10 GeV, ($|\eta| < 2.4$)',
        }
...
# ID + ISO + SIP
#cfg["trainings"] = {}
#cfg["trainings"]["Fall_17_ID_ISO_SIP"] = {}
#
#cfg["trainings"]["Fall_17_ID_ISO_SIP"]["pT_5"] = {
#        "cut": "mu_pT < 10. & abs(mu_eta) <= 2.4",
#        "variables": variables_base_iso_sip,
#        "label": r'5 < $p_T$ < 10 GeV, ($|\eta| < 2.4$)',
#        }
#        
#cfg["trainings"]["Fall_17_ID_ISO_SIP"]["pT_10"] = {
#        "cut": "mu_pT >= 10. & abs(mu_eta) <= 2.4",
#        "variables": variables_base_iso_sip,
#        "label": r'5 < $p_T$ > 10 GeV, ($|\eta| < 2.4$)',
#        }
...
cfg["working_points"] = {}
cfg["working_points"]["Fall_17_ID_ISO_SIP"] = {}


cfg["working_points"]["Fall_17_ID_ISO_SIP"]["MVA_Muon_Fall_17_ID_ISO_SIP_HZZ"] = {
...
cfg["cmssw_cff"] = {}
cfg["cmssw_cff"]["Fall_17_ID_ISO_SIP"] = {}

cfg["cmssw_cff"]["Fall_17_ID_ISO_SIP"] = {
        "producer_config_name": "MVA_Muon_Fall_17_ID_ISO_SIP_producer_config",
        "file_name": "MVA_Muon_Fall_17_ID_ISO_SIP_cff.py",
        "mvaTag": "MuonFall17IdIsoSip",
