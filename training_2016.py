...
for idname in cfg["trainings"]:
    ...
    for training_bin in cfg["trainings"][idname]:
        ...
        df = tree.pandas.df(feature_cols + ["mu_pT", "mu_dz", "mu_dxy", "mu_sip", "is_tracker_mu", "is_global_mu", "matchedToGenMu", "n_obs_int",
                                            "is_pf_mu", "mu_pu_charged_had_iso"], entrystop=None)
        ...
        df_reduced = df.loc[y_test.index, ["mu_pT", "mu_eta", "is_pf_mu", "mu_pf_charged_had_iso", "mu_pf_neutral_had_iso",
                                           "mu_pf_photon_iso", "mu_pu_charged_had_iso", "mu_sip", "mu_dxy", "mu_dz", "n_obs_int", "y"]]
